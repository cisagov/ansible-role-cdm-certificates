...
issue](https://github.com/cisagov/ansible-role-cdm-certificates/issues) in
...
request](https://github.com/cisagov/ansible-role-cdm-certificates/pulls), you
...
```console
cd ansible-role-cdm-certificates
pyenv virtualenv <python_version_to_use> ansible-role-cdm-certificates
pyenv local ansible-role-cdm-certificates
