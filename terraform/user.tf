...
module "user" {
  ...
  role_description = "A role that can be assumed to allow for CI testing of ansible-role-cdm-certificates via Molecule."
  role_name        = "Test-ansible-role-cdm-certificates"
  user_name        = "test-ansible-role-cdm-certificates"
}
