...
output "user" {
  description = "The IAM user being created to test the cisagov/ansible-role-cdm-certificates Ansible role."
  value       = module.user.user
}

output "user_access_key" {
  description = "The IAM access for the IAM user being created to test the cisagov/ansible-role-cdm-certificates Ansible role."
  sensitive   = true
