...
output "production_role" {
  ...
  description = "The IAM role that the CI user can assume to read certain objects in the production third-party S3 bucket."
}
...
output "staging_role" {
  ...
  description = "The IAM role that the CI user can assume to read certain objects in the staging third-party S3 bucket."
}
